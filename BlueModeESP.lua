...
-- ✅ NO TIMER / NO LIMITS | FIXED PING/FPS
-- ✅ EXIT CONFIRM | RAINBOW ESP + FRIEND DOT
...
function LoadMainHub()
    ...
    local function SetupDeathCheck()
        local function CheckCharacter(Char)
            ...
            Hum.Died:Connect(function() if ESP_Enabled then ESP_Enabled = false; if ESPBtn then ESPBtn.Text = "ESP: OFF"; ESPBtn.BackgroundColor3 = Color3.fromRGB(40,40,40) end; ClearAllESP() end end)
        end
    ...
    local function ToggleBoomboxMenu()
        ...
        CloseTop.Text = "✕"; CloseTop.TextColor3 = Color3.new(1,1,1); CloseTop.Font = Enum.Font.GothamBold; CloseTop.TextSize = 24; CloseTop.ZIndex = 3; CloseTop.Parent = BoomFrame
        CloseTop.MouseButton1Click:Connect(function() ToggleBoomboxMenu() end)

        local Title = Instance.new("TextLabel")
        Title.Size = UDim2.new(1,-70,0,40)
        Title.Position = UDim2.new(0,12,0,8)
        Title.BackgroundTransparency = 1; Title.Text = "🎵 BOOMBOX & VOLUME"; Title.TextColor3 = Color3.new(1,1,1); Title.Font = Enum.Font.GothamBold; Title.TextScaled = true; Title.TextXAlignment = Enum.TextXAlignment.Left; Title.ZIndex = 2; Title.Parent = BoomFrame

        local Input = Instance.new("TextBox")
        Input.Size = UDim2.new(1,-40,0,45)
        Input.Position = UDim2.new(0,20,0,55)
        Input.BackgroundColor3 = Color3.fromRGB(35,35,35)
        Input.PlaceholderText = "Paste Sound ID here..."; Input.TextColor3 = Color3.new(1,1,1); Input.Font = Enum.Font.Gotham; Input.TextScaled = true; Input.ZIndex = 2; Input.Parent = BoomFrame
        ...
        VolLabel.BackgroundTransparency = 1; VolLabel.Text = "🔊 VOLUME (0–1000):"; VolLabel.TextColor3 = Color3.new(1,1,1); VolLabel.Font = Enum.Font.GothamBold; VolLabel.TextScaled = true; VolLabel.ZIndex = 2; VolLabel.Parent = BoomFrame

        VolNumMenu = Instance.new("TextLabel")
        VolNumMenu.Size = UDim2.new(0,60,0,30)
        VolNumMenu.Position = UDim2.new(1,-80,0,110)
        VolNumMenu.BackgroundTransparency = 1; VolNumMenu.Text = tostring(math.floor(MusicVolume+0.5)); VolNumMenu.TextColor3 = Color3.new(1,1,1); VolNumMenu.Font = Enum.Font.GothamBold; VolNumMenu.TextScaled = true; VolNumMenu.ZIndex = 2; VolNumMenu.Parent = BoomFrame
        ...
        UserInputService.InputChanged:Connect(function(i) if SliderActive then local rel = math.clamp((i.Position.X - VolBG.AbsolutePosition.X)/VolBG.AbsoluteSize.X, 0, 1); UpdateVolume(math.floor(rel * VOLUME_MAX)) end end)

        local PlayBtn = Instance.new("TextButton")
        PlayBtn.Size = UDim2.new(0,130,0,40)
        PlayBtn.Position = UDim2.new(0,20,0,190)
        PlayBtn.BackgroundColor3 = Color3.fromRGB(25,140,255); PlayBtn.Text = "▶ PLAY SOUND"; PlayBtn.TextColor3 = Color3.new(1,1,1); PlayBtn.Font = Enum.Font.GothamBold; PlayBtn.TextScaled = true; PlayBtn.ZIndex = 2; PlayBtn.Parent = BoomFrame
        ...
        StopBtn.BackgroundColor3 = Color3.fromRGB(200,30,30); StopBtn.Text = "⏹ STOP SOUND"; StopBtn.TextColor3 = Color3.new(1,1,1); StopBtn.Font = Enum.Font.GothamBold; StopBtn.TextScaled = true; StopBtn.ZIndex = 2; StopBtn.Parent = BoomFrame
    ...
    local function ToggleConsole()
        ...
        ConsoleGuiBg.BackgroundTransparency = 1; ConsoleGuiBg.Image = CUSTOM_GUI_BG; ConsoleGuiBg.ScaleType = Enum.ScaleType.Stretch; ConsoleGuiBg.ZIndex = 1; ConsoleGuiBg.Parent = Frame
        AddRainbowGlow(Frame,5)

        local CloseTop = Instance.new("TextButton")
        CloseTop.Size = UDim2.new(0,32,0,32)
        CloseTop.Position = UDim2.new(1,-37,0,6)
        CloseTop.BackgroundColor3 = Color3.fromRGB(170,30,30); CloseTop.Text = "✕"; CloseTop.TextColor3 = Color3.new(1,1,1); CloseTop.Font = Enum.Font.GothamBold; CloseTop.TextSize = 26; CloseTop.ZIndex = 3; CloseTop.Parent = Frame
        CloseTop.MouseButton1Click:Connect(function() ToggleConsole() end)

        local Title = Instance.new("TextLabel")
        Title.Size = UDim2.new(1,-50,0,35)
        Title.Position = UDim2.new(0,15,0,6)
        Title.BackgroundTransparency = 1; Title.Text = "💻 CONSOLE"; Title.TextColor3 = Color3.new(1,1,1); Title.Font = Enum.Font.GothamBold; Title.TextScaled = true; Title.TextXAlignment = Enum.TextXAlignment.Left; Title.ZIndex = 2; Title.Parent = Frame

        local Output = Instance.new("TextLabel")
        Output.Size = UDim2.new(1,-30,0,40)
        Output.Position = UDim2.new(0,15,0,45)
        Output.BackgroundTransparency = 1; Output.Text = "Paste script code below..."; Output.TextColor3 = Color3.fromRGB(0,255,120); Output.Font = Enum.Font.Code; Output.TextScaled = true; Output.TextXAlignment = Enum.TextXAlignment.Left; Output.TextWrapped = true; Output.ZIndex = 2; Output.Parent = Frame
        Instance.new("UICorner", Output).CornerRadius = UDim.new(0,8)

        local Input = Instance.new("TextBox")
        Input.Size = UDim2.new(1,-30,0,130)
        Input.Position = UDim2.new(0,15,0,95)
        Input.BackgroundColor3 = Color3.fromRGB(45,45,45); Input.PlaceholderText = "Paste your script here..."; Input.TextColor3 = Color3.new(1,1,1); Input.Font = Enum.Font.Code; Input.TextScaled = true; Input.MultiLine = true; Input.ZIndex = 2; Input.Parent = Frame
        Instance.new("UICorner", Input).CornerRadius = UDim.new(0,8); AddRainbowGlow(Input,2)

        local ExecBtn = Instance.new("TextButton")
        ExecBtn.Size = UDim2.new(0,120,0,40)
        ExecBtn.Position = UDim2.new(0,15,0,240)
        ExecBtn.BackgroundColor3 = Color3.fromRGB(20,150,70); ExecBtn.Text = "▶ EXECUTE"; ExecBtn.TextColor3 = Color3.new(1,1,1); ExecBtn.Font = Enum.Font.GothamBold; ExecBtn.TextScaled = true; ExecBtn.ZIndex = 2; ExecBtn.Parent = Frame
        ...
        ClearBtn.BackgroundColor3 = Color3.fromRGB(180,120,20); ClearBtn.Text = "🗑️ CLEAR"; ClearBtn.TextColor3 = Color3.new(1,1,1); ClearBtn.Font = Enum.Font.GothamBold; ClearBtn.TextScaled = true; ClearBtn.ZIndex = 2; ClearBtn.Parent = Frame
    ...
    MainFrame.BackgroundColor3 = Color3.fromRGB(25,25,25); MainFrame.Active = true; MainFrame.ClipsDescendants = false; MainFrame.Parent = MainUI
    ...
    DragHandle.BackgroundColor3 = Color3.fromRGB(60,140,220); DragHandle.Active = true; DragHandle.Text = "made by BLUE_MODE | DRAG HERE"; DragHandle.TextColor3 = Color3.new(1,1,1); DragHandle.Font = Enum.Font.GothamBold; DragHandle.TextScaled = true; DragHandle.TextXAlignment = Enum.TextXAlignment.Left; DragHandle.Parent = MainFrame
    AddRainbowGlow(DragHandle,2)

    local MinBtn = Instance.new("TextButton")
    MinBtn.Size = UDim2.new(0,22,1,0)
    MinBtn.Position = UDim2.new(1,-22,0,0)
    MinBtn.BackgroundColor3 = Color3.fromRGB(200,50,50); MinBtn.Text = "➖"; MinBtn.TextColor3 = Color3.new(1,1,1); MinBtn.Font = Enum.Font.GothamBold; MinBtn.TextScaled = true; MinBtn.Parent = MainFrame
    AddRainbowGlow(MinBtn,2)

    ESPBtn = Instance.new("TextButton")
    ESPBtn.Size = UDim2.new(0,85,0,30)
    ESPBtn.Position = UDim2.new(0,10,0,30)
    ESPBtn.BackgroundColor3 = Color3.fromRGB(40,40,40); ESPBtn.Text = "ESP: OFF"; ESPBtn.TextColor3 = Color3.new(1,1,1); ESPBtn.Font = Enum.Font.GothamBold; ESPBtn.TextScaled = true; ESPBtn.Parent = MainFrame
    ...
    YouTubeBtn.BackgroundColor3 = Color3.fromRGB(200,30,30); YouTubeBtn.Text = "📺 YT"; YouTubeBtn.TextColor3 = Color3.new(1,1,1); YouTubeBtn.Font = Enum.Font.GothamBold; YouTubeBtn.TextScaled = true; YouTubeBtn.Parent = MainFrame
    ...
    MusicBtn.BackgroundColor3 = Color3.fromRGB(40,80,160); MusicBtn.Text = "🎵 MUSIC"; MusicBtn.TextColor3 = Color3.new(1,1,1); MusicBtn.Font = Enum.Font.GothamBold; MusicBtn.TextScaled = true; MusicBtn.Parent = MainFrame
    ...
    LockBtn.BackgroundColor3 = Color3.fromRGB(50,50,50); LockBtn.Text = "🔓 UNLOCK"; LockBtn.TextColor3 = Color3.new(1,1,1); LockBtn.Font = Enum.Font.GothamBold; LockBtn.TextScaled = true; LockBtn.Parent = MainFrame
    ...
    ConsoleBtn.BackgroundColor3 = Color3.fromRGB(30,120,90); ConsoleBtn.Text = "💻 CONSOLE"; ConsoleBtn.TextColor3 = Color3.new(1,1,1); ConsoleBtn.Font = Enum.Font.GothamBold; ConsoleBtn.TextScaled = true; ConsoleBtn.Parent = MainFrame
    ...
    ExitBtn.BackgroundColor3 = Color3.fromRGB(140,20,20); ExitBtn.Text = "🗑️ EXIT"; ExitBtn.TextColor3 = Color3.new(1,1,1); ExitBtn.Font = Enum.Font.GothamBold; ExitBtn.TextScaled = true; ExitBtn.Parent = MainFrame
    ...
    VolLabelMain.BackgroundTransparency = 1; VolLabelMain.Text = "🔊 VOLUME:"; VolLabelMain.TextColor3 = Color3.new(1,1,1); VolLabelMain.Font = Enum.Font.Gotham; VolLabelMain.TextScaled = true; VolLabelMain.Parent = MainFrame

    VolNumTextMain = Instance.new("TextLabel")
    VolNumTextMain.Size = UDim2.new(0,50,0,25)
    VolNumTextMain.Position = UDim2.new(0,115,0,65)
    VolNumTextMain.BackgroundTransparency = 1; VolNumTextMain.Text = tostring(math.floor(MusicVolume+0.5)); VolNumTextMain.TextColor3 = Color3.new(1,1,1); VolNumTextMain.Font = Enum.Font.GothamBold; VolNumTextMain.TextScaled = true; VolNumTextMain.Parent = MainFrame

    local VolBGMain = Instance.new("Frame")
    VolBGMain.Size = UDim2.new(0,150,0,18)
    VolBGMain.Position = UDim2.new(0,175,0,67)
    VolBGMain.BackgroundColor3 = Color3.fromRGB(50,50,50); VolBGMain.Active = true; VolBGMain.Parent = MainFrame
    ...
    FPSLabel.BackgroundTransparency = 1; FPSLabel.Font = Enum.Font.GothamBold; FPSLabel.TextScaled = true; FPSLabel.Text = "FPS: 0"; FPSLabel.TextColor3 = Color3.fromRGB(80,255,120); FPSLabel.Parent = StatsBG

    PingLabel = Instance.new("TextLabel")
    PingLabel.Size = UDim2.new(0.33,0,1,0)
    PingLabel.Position = UDim2.new(0.33,0,0,0)
    PingLabel.BackgroundTransparency = 1; PingLabel.Font = Enum.Font.GothamBold; PingLabel.TextScaled = true; PingLabel.Text = "PING: 0"; PingLabel.TextColor3 = Color3.fromRGB(255,200,50); PingLabel.Parent = StatsBG
    ...
    ServerPingLabel.BackgroundTransparency = 1; ServerPingLabel.Font = Enum.Font.GothamBold; ServerPingLabel.TextScaled = true; ServerPingLabel.Text = "SP: 0"; ServerPingLabel.TextColor3 = Color3.fromRGB(255,100,100); ServerPingLabel.Parent = StatsBG
    ...
    UserInputService.InputChanged:Connect(function(i) if SliderActiveMain then local rel = math.clamp((i.Position.X - VolBGMain.AbsolutePosition.X)/VolBGMain.AbsoluteSize.X, 0, 1); UpdateVolume(math.floor(rel * VOLUME_MAX)) end end)
    ...
    RunService.Heartbeat:Connect(function(Delta)
        ...
        local ClientPing = GetClientPing()
        local ServerPing = 0
        ...
        ServerPing = math.max(ServerPing, ClientPing)
    ...
    print("✅ BLUE MODE HUB FULLY LOADED | NO LIMITS | ALL FEATURES ACTIVE")
end
