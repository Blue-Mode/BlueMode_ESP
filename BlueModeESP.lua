-- ==============================================
-- BLUE MODE HUB | FINAL RUNNABLE VERSION
-- FIXED ALL SYNTAX & EXECUTOR ISSUES
-- BACKGROUND: rbxassetid://85473171152747
-- YOUTUBE: https://youtube.com/@blue_mode?si=kCM2t8MILYWQzQzw
-- ==============================================
if getgenv and getgenv().BlueModeHub then return end
...
LinkBtn.MouseButton1Click:Connect(function()
    if setclipboard then setclipboard(YT_LINK) end
...
RunService.Heartbeat:Connect(function(dt)
    ...
    for _, item in pairs(rainbowObjs) do
        if item and item.Obj then
            if item.Type == "Stroke" then item.Obj.Color = color end
            if item.Type == "Text" then item.Obj.TextColor3 = color end
        end
    end
