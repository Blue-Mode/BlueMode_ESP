...
function LoadMainHub()
    ...
    -- FIXED PING FUNCTION WORKS ON ALL EXECUTORS
    local function GetClientPing()
        local pcall = pcall
        local tick = os.clock
        local s = tick()
        task.wait()
        return math.floor((tick() - s) * 1000)
    end
...
-- END OF PART 1 | RUN PART 2 RIGHT AFTER
-- CONTINUATION OF BLUE MODE HUB | FULL UNTRUNCATED PART 2
