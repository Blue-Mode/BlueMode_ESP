...
-- ⚠️ END OF PART 1 — RUN PART 2 NOW ⚠️
    ...
    RunService.Heartbeat:Connect(function(Delta)
        ...
        for _,P in pairs(Players:GetPlayers()) do
            ...
            if P.UserId == LOCAL_USERID then
                ...
                if not Crown then
                    Crown = Instance.new("BillboardGui")
            ...
            elseif P:IsFriendsWith(LocalPlayer.UserId) then
                ...
                if Dot and Dot:FindFirstChild("Frame") then Dot.Frame.BackgroundColor3 = Rainbow end
            -- Normal Player Rainbow
            else
                Outline.Color = Rainbow
                Outline.Transparency = 0.5
