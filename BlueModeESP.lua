...
local function ShowGlobalCountdownPopup()
    ...
    PopupGui.Name = "BlueMode_Global_Popup"
    ...
    Title.Size = UDim2.new(1,-40,0,65)
    ...
    GlobalLabel.Size = UDim2.new(1,-40,0,30)
    GlobalLabel.Position = UDim2.new(0,20,0,90)
    GlobalLabel.BackgroundTransparency = 1
    GlobalLabel.Text = "Global Countdown"
    GlobalLabel.TextColor3 = Color3.fromRGB(80,190,255)
    GlobalLabel.Font = Enum.Font.GothamSemibold
    GlobalLabel.TextScaled = true
    GlobalLabel.Parent = Box

    local Timer = Instance.new("TextLabel")
    Timer.Size = UDim2.new(1,-40,0,55)
    Timer.Position = UDim2.new(0,20,0,125)
    ...
    OkBtn.Size = UDim2.new(0,150,0,45)
    OkBtn.Position = UDim2.new(0.5,-75,1,-60)
    OkBtn.BackgroundColor3 = Color3.fromRGB(35,150,90)
    OkBtn.Text = "OK"
    ...
    RunService.Heartbeat:Connect(function()
        ...
        Timer.Text = d > 0 
            and string.format("%d Day • %02d:%02d:%02d", d, h, m, s)
            or string.format("%02d:%02d:%02d", h, m, s)
        
        if Remaining <= 0 then
            Timer.Text = "✅ RELEASED!"
            GlobalLabel.Text = "Global Release • Now Live"
        end
    end)
