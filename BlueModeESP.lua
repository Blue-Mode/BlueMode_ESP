-- ==============================================
-- 🔵 BLUE MODE HUB | FINAL CLEAN VERSION
-- ✅ NO TIMER / NO LIMITS / NO COOLDOWN
-- ✅ EXIT CONFIRM POPUP ADDED
...
• ✅ REMOVED: All timers / limits / cooldowns
...
-- ==============================================
-- EXIT CONFIRM POPUP (MATCHES ALL SCREENS)
-- ==============================================
local function ShowExitConfirm()
    ...
    PopupTitle.Text = "⚠️ EXIT CONFIRMATION"
    PopupTitle.ZIndex = 2
...
function LoadMainHub()
    ...
    RunService.Heartbeat:Connect(function(Delta)
        ...
        -- ==============================================
        -- FULL ESP SYSTEM (ALL FEATURES INCLUDED)
        -- ==============================================
            ...
            if Player ~= LocalPlayer then
                ...
                if Character then
                    ...
                    if Humanoid and RootPart and Humanoid.Health > 0 then
                        ...
                        local Outline = Character:FindFirstChild("BLUE_Outline")
                        if not Outline then
                            Outline = Instance.new("ForceField")
                        ...
                        elseif IsFriend then
                            Outline.Color = Color3.fromHSV(Hue, 1, 1) -- RAINBOW FOR FRIENDS
                        else
                            Outline.Color = Color3.fromRGB(255,50,50) -- RED FOR ENEMIES
                        end

                        -- FRIEND RAINBOW INDICATOR DOT
                        if IsFriend then
                            local Indicator = Character:FindFirstChild("FriendRainbowDot")
                            if not Indicator then
                                Indicator = Instance.new("Part")
                                Indicator.Name = "FriendRainbowDot"
                            ...
                            Indicator.Position = RootPart.Position + Vector3.new(0, 3, 0)
                        else
                            if Character:FindFirstChild("FriendRainbowDot") then
                                Character.FriendRainbowDot:Destroy()
                            end
                        end
