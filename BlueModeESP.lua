-- ==============================================
-- 🔵 BLUE MODE HUB | FULL FINAL VERSION | PART 1/2
...
• ✅ ESP: Rainbow outline + Friend rainbow dot
...
function LoadMainHub()
    ...
    -- ==============================================
-- 🔵 BLUE MODE HUB | FULL FINAL VERSION | PART 2/2
-- ✅ UNCUT | ALL ESP, RAINBOW, OWNER/FRIEND FEATURES
-- ✅ CROSS-EXECUTOR COMPATIBLE
-- ==============================================

-- MAIN UI INTERACTIONS & DRAG
    ...
    -- ✅ FULL ESP SYSTEM + MAIN UPDATE LOOP
    RunService.Heartbeat:Connect(function(Delta)
        ...
        -- ESP MECHANIC — FULLY PRESERVED EXACTLY
        ...
        for _,P in pairs(Players:GetPlayers()) do
            ...
            elseif IsFriend then
                ...
                if not Char:FindFirstChild("FriendRainbowDot") then
                    ...
                    Point.BackgroundColor3 = Rainbow
                ...
                Outline.FillColor = Color3.fromRGB(255,50,50) -- RED ENEMY
                Outline.OutlineColor = Color3.fromRGB(255,50,50)
                -- REMOVE DOT FROM ENEMIES
                if Char:FindFirstChild("FriendRainbowDot") then Char.FriendRainbowDot:Destroy() end
            end
        end
    end)

    -- AUTO SAVE ON EXIT / CLOSE
    game:BindToClose(function()
        SaveData(SAVE_KEY_USED, UsedTime)
    end)

    print("✅ BLUE MODE HUB FULLY LOADED SUCCESSFULLY!")
    print("🔵 Features: Rainbow Outline, Friend Dots, Owner Gold+Crown, FPS/PING/SP, Boombox, Draggable UI")
end
