-- ==============================================
-- BLUE MODE BOOMBOX | 100% SKETCH MATCH
-- BACKGROUND: rbxassetid://101782008402770
-- COLOR RULES: Green Outline = Rainbow | Blue Text = White
-- MINIMIZED GUI IS ALSO DRAGGABLE
-- ==============================================
...
MainWin.BackgroundColor3 = Color3.fromRGB(25, 25, 35)
MainWin.Active = true
...
Title.TextSize = 34
Title.TextColor3 = Color3.new(1,1,1) -- White/Blue Text
Title.Parent = TopBar
...
ESP_Box.BackgroundColor3 = Color3.fromRGB(40, 160, 60) -- ON = Green
...
ID_Box.BackgroundColor3 = Color3.fromRGB(15,15,25)
...
LinkBtn.BackgroundColor3 = Color3.fromRGB(40, 160, 60)
LinkBtn.Text = "Link\nYT"
...
local PlayBtn = MakeBtn("Play", UDim2.new(0,80,0,310), UDim2.new(0,330,0,90), Color3.fromRGB(30,90,180))
local StopBtn = MakeBtn("Stop", UDim2.new(0,420,0,310), UDim2.new(0,145,0,90), Color3.fromRGB(180,30,30))
local ClearBtn = MakeBtn("Clear", UDim2.new(0,80,0,410), UDim2.new(0,250,0,80), Color3.fromRGB(40,40,60))
local VolBtn = MakeBtn("500\n1000", UDim2.new(0,340,0,410), UDim2.new(0,110,0,80), Color3.fromRGB(40,40,60))
local DeleteBtn = MakeBtn("Delete", UDim2.new(0,460,0,410), UDim2.new(0,110,0,80), Color3.fromRGB(180,30,30))
...
ExpandBtn.BackgroundColor3 = Color3.fromRGB(40,40,60)
ExpandBtn.Text = "⬆"
...
ESP_Box.MouseButton1Click:Connect(function()
    ...
    ESP_Box.BackgroundColor3 = ESP_Enabled and Color3.fromRGB(40,160,60) or Color3.fromRGB(180,30,30)
...
print("✅ BLUE MODE BOOMBOX FULLY LOADED!")
print("✅ All sketch features applied | Link YT | ESP Toggle | Draggable Minimize")
