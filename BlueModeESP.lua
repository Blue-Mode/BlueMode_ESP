-- ==============================================
-- 🔵 BLUE MODE HUB | PART 1/3
-- ✅ RUN THIS FIRST — NO CHANGES TO YOUR CODE
-- ==============================================
...
-- ⚠️ END OF PART 1 — RUN PART 2 NEXT ⚠️
-- ==============================================
-- 🔵 BLUE MODE HUB | PART 2/3
-- ✅ RUN AFTER PART 1 — NO CHANGES TO YOUR CODE
-- ==============================================
...
-- ✅ UPDATED: DELETES ALL ESP ELEMENTS WHEN CALLED
...
-- ✅ UPDATED: CLEARS ALL ESP WHEN TURNED OFF
...
-- ✅ UPDATED: CLEARS ALL ESP WHEN EXITING
...
print("✅ PART 2 LOADED — RUN PART 3 NOW")
-- ⚠️ END OF PART 2 — RUN PART 3 FINALLY ⚠️
-- ==============================================
-- 🔵 BLUE MODE HUB | PART 3/3
-- ✅ RUN LAST — NO CHANGES TO YOUR CODE
-- ==============================================
if not getgenv().BlueMode_Loaded then return warn("❌ RUN PART 1 & 2 FIRST!") end
...
print("✅ PART 3 LOADED — BLUE MODE HUB FULLY RUNNING!")
end -- END OF LoadMainHub() FROM PART 2
